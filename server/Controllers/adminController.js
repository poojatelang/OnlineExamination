...
exports.createQuestion = async (req, res) => {
  try {
    const { type, difficulty, category, question, correctAnswer, options } =
      req.body;
    ...
    if (
      ...
      return res
        ...
        .json({
          message:
            "Invalid input: Ensure all fields are filled and options are an array with at least two values.",
        });
    }
    ...
    res
      .status(500)
      .json({ message: "Question creation failed", error: error.message });
  }
};
  ...
  try {
    ...
    res
      ...
      .json({
        ...
        message: "Question updated sccessfully",
      });
  } catch (error) {
